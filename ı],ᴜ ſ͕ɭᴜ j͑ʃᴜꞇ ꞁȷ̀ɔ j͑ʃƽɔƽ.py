...
class ចាថេសអេស្កេក:
    ...
    def ថារឺថា(self, ចាត្សារា, ង៏កិ១សៃអេស្កេក = False, ង៏កិហាតេ = None):
        if ង៏កិ១សៃអេស្កេក:
            ចាត្សារា = ["<j͑ʃı],>"] + ចាត្សារា + ["<ſ̀ȷſɭſɭ>"]

        ថារឺថានី = [self.ភាលកេភអៃ.get(កេក, "<ſɭſɭſ͕ȷ>") for កេក in ចាត្សារា]

        if ង៏កិហាតេ == "֭ſɭwʞ":
            import torch
            ថារឺថានី = torch.tensor(ថារឺថានី)
